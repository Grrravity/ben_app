...
mixin _$CreateParcoursCmd {
  ...
  @JsonKey(ignore: true)
  $CreateParcoursCmdCopyWith<CreateParcoursCmd> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateParcoursCmdCopyWith<$Res> {
  factory $CreateParcoursCmdCopyWith(
          CreateParcoursCmd value, $Res Function(CreateParcoursCmd) then) =
      _$CreateParcoursCmdCopyWithImpl<$Res, CreateParcoursCmd>;
  @useResult
  $Res call(
      {String name,
      List<String> ways,
...
/// @nodoc
class _$CreateParcoursCmdCopyWithImpl<$Res, $Val extends CreateParcoursCmd>
    implements $CreateParcoursCmdCopyWith<$Res> {
  _$CreateParcoursCmdCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateParcoursCmdImplCopyWith<$Res>
    implements $CreateParcoursCmdCopyWith<$Res> {
  factory _$$CreateParcoursCmdImplCopyWith(_$CreateParcoursCmdImpl value,
          $Res Function(_$CreateParcoursCmdImpl) then) =
      __$$CreateParcoursCmdImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String name,
...
/// @nodoc
class __$$CreateParcoursCmdImplCopyWithImpl<$Res>
    extends _$CreateParcoursCmdCopyWithImpl<$Res, _$CreateParcoursCmdImpl>
    implements _$$CreateParcoursCmdImplCopyWith<$Res> {
  __$$CreateParcoursCmdImplCopyWithImpl(_$CreateParcoursCmdImpl _value,
      $Res Function(_$CreateParcoursCmdImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateParcoursCmdImpl(
      name: null == name
          ? _value.name
          : name // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$CreateParcoursCmdImpl implements _CreateParcoursCmd {
  const _$CreateParcoursCmdImpl(
      {required this.name,
      required final List<String> ways,
      required final List<String> municipalities,
      required final List<Section> sections,
  ...
  @override
  String toString() {
    return 'CreateParcoursCmd(name: $name, ways: $ways, municipalities: $municipalities, sections: $sections, intersections: $intersections)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateParcoursCmdImpl &&
            (identical(other.name, name) || other.name == name) &&
            const DeepCollectionEquality().equals(other._ways, _ways) &&
            const DeepCollectionEquality()
                .equals(other._municipalities, _municipalities) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateParcoursCmdImplCopyWith<_$CreateParcoursCmdImpl> get copyWith =>
      __$$CreateParcoursCmdImplCopyWithImpl<_$CreateParcoursCmdImpl>(
          this, _$identity);
}

abstract class _CreateParcoursCmd implements CreateParcoursCmd {
  const factory _CreateParcoursCmd(
          {required final String name,
          required final List<String> ways,
          required final List<String> municipalities,
          required final List<Section> sections,
          required final List<Intersection> intersections}) =
      _$CreateParcoursCmdImpl;
