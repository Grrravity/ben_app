import 'package:ben_app/data/model/project/pictures_settings_dto.dart';
import 'package:ben_app/domain/entities/project/project_settings.dart';
import 'package:freezed_annotation/freezed_annotation.dart';

part '../generated/project/project_settings_dto.freezed.dart';
part '../generated/project/project_settings_dto.g.dart';

@freezed
class ProjectSettingsDTO with _$ProjectSettingsDTO {
  @JsonSerializable(explicitToJson: true)
  const factory ProjectSettingsDTO({
    required List<PicturesSettingsDTO> sectionPictureSetting,
    required List<PicturesSettingsDTO> intersectionPictureSetting,
  }) = _ProjectSettingsDTO;
