  ...
  Widget build(BuildContext context) {
    return MainScaffold(
      ...
      body: BlocProvider(
        ...
        child:
            BlocBuilder<ProjectCreateCubit, FormBlocState<ProjectCreateState>>(
          builder: (context, state) {
            return state.map(
                      ...
                      children: [
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            final element =
                                sectionSettings.value!.entries.elementAt(index);
                            return Row(
                              children: [
                                Flexible(
                                  child: Padding(
                                ...
                                Flexible(
                                  child: CustomTextFormField.required(
                                    ...
                                    onChanged: (value) =>
                                        cubit.setSectionPictureSettingFromIndex(
                                      MapEntry<String, int>(
                                        element.key,
                                        int.parse(value),
                                      ),
                        ...
                        ListView.builder(
                          shrinkWrap: true,
                          itemCount: intersectionSettings.value!.entries.length,
                          itemBuilder: (context, index) {
                            final element = intersectionSettings.value!.entries
                                .elementAt(index);
                            return Row(
                              children: [
                                Flexible(
              ...
              loadFailed: (state) => Center(child: ErrorLayout(state.failure)),
            );
          },
        ),
      ),
